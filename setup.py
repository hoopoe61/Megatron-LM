...
setuptools.setup(
    ...
    packages=setuptools.find_namespace_packages(include=["megatron.core", "megatron.core.*", "megatron.inference", "megatron.inference.*", "megatron.legacy", "megatron.legacy.*", "megatron.training", "megatron.training.*"]),
    ext_modules=[
        Extension(
